...
const layouts = [
  { title: "两栏式", value: "1", desc: "放置商品区与购物车" },
  { title: "三栏式", value: "2", desc: "放置商品区、购物车与独立的功能区" },
];

const Whole = observer(() => {
  return (
    <div>
      <div className="h-[38px] px-[12px] mb-[16px] flex items-center bg-[#FBFBFB] rounded-[5px]">
        ...
        <span className="mx-[16px] font-bold">点单页整体布局</span>
        <span className="text-[10px]">设置点单页的整体布局栅格</span>
      </div>
