import { getDOMInfo, ROOT_NODE } from '@/Components/Designer/Layout/utils';
...
export class Positioner {
   ...
   */
  computeIndicator(dropTargetId: NodeId, x: number, y: number): Indicator | null {
    ...
    if (
      newParentNode.data.parent && newParentNode.dom &&
    ...
    const currentNode =
      currentNodeId ? this.store.query.node(currentNodeId).get() : null;
