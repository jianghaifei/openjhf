...
import 'package:flutter_report_project/function/login/login_binding.dart';
import 'package:flutter_report_project/function/login/login_view.dart';
...
import '../function/analytics/analytics_add/analytics_add_template/analytics_add_chart/analytics_add_chart_subviews/analytics_add_filter_sub_view/analytics_add_filter_sub_view_view.dart';
...
class AppRoutes {
  ...
  static String analyticsAddFilterSubViewPage = '/analytics_add_filter_sub_view_page';
  ...
  static final List<GetPage> routes = [
    ...
    GetPage(name: analyticsAddFilterSubViewPage, page: () => const AnalyticsAddFilterSubViewPage()),
