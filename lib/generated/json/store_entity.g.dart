...
StoreEntity $StoreEntityFromJson(Map<String, dynamic> json) {
  ...
  final List<StoreShops>? shops =
      (json['shops'] as List<dynamic>?)?.map((e) => jsonConvert.convert<StoreShops>(e) as StoreShops).toList();
  if (shops != null) {
    storeEntity.shops = shops;
  }
  final List<StoreBrands>? brands =
      (json['brands'] as List<dynamic>?)?.map((e) => jsonConvert.convert<StoreBrands>(e) as StoreBrands).toList();
  if (brands != null) {
    storeEntity.brands = brands;
  }
  final List<StoreCurrencyShops>? currencyShops = (json['currencyShops'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<StoreCurrencyShops>(e) as StoreCurrencyShops)
      .toList();
  ...
  final StoreSelectedGroupType? selectedGroupType = jsonConvert.convert<StoreSelectedGroupType>(
      ...
      enumConvert: (v) => StoreSelectedGroupType.values.byName(v));
...
StoreCurrencyShops $StoreCurrencyShopsFromJson(Map<String, dynamic> json) {
  ...
  final List<StoreCurrencyShopsGroupShops>? allShops = (json['allShops'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<StoreCurrencyShopsGroupShops>(e) as StoreCurrencyShopsGroupShops)
      .toList();
  if (allShops != null) {
    storeCurrencyShops.allShops = allShops;
  }
  final List<StoreCurrencyShopsGroupShops>? groupShops = (json['groupShops'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<StoreCurrencyShopsGroupShops>(e) as StoreCurrencyShopsGroupShops)
      .toList();
  if (groupShops != null) {
...
StoreCurrencyShopsGroupShops $StoreCurrencyShopsGroupShopsFromJson(Map<String, dynamic> json) {
  ...
  final StoreCurrencyShopsGroupShopsShopGroup? shopGroup =
      jsonConvert.convert<StoreCurrencyShopsGroupShopsShopGroup>(json['shopGroup']);
  if (shopGroup != null) {
...
StoreCurrencyShopsGroupShopsShopGroup $StoreCurrencyShopsGroupShopsShopGroupFromJson(Map<String, dynamic> json) {
  final StoreCurrencyShopsGroupShopsShopGroup storeCurrencyShopsGroupShopsShopGroup =
...
StoreCurrencyShopsGroupShopsBrandShops $StoreCurrencyShopsGroupShopsBrandShopsFromJson(Map<String, dynamic> json) {
  final StoreCurrencyShopsGroupShopsBrandShops storeCurrencyShopsGroupShopsBrandShops =
