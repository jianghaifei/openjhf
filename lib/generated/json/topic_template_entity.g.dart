...
TopicTemplateEntity $TopicTemplateEntityFromJson(Map<String, dynamic> json) {
  ...
  final List<TopicTemplateTemplates>? templates = (json['templates'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<TopicTemplateTemplates>(e) as TopicTemplateTemplates)
      .toList();
  if (templates != null) {
...
extension TopicTemplateEntityExtension on TopicTemplateEntity {
  TopicTemplateEntity copyWith({
    ...
    return TopicTemplateEntity()..templates = templates ?? this.templates;
  }
}
...
TopicTemplateTemplates $TopicTemplateTemplatesFromJson(Map<String, dynamic> json) {
  ...
  final List<TopicTemplateTemplatesNavs>? navs = (json['navs'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<TopicTemplateTemplatesNavs>(e) as TopicTemplateTemplatesNavs)
      .toList();
  if (navs != null) {
...
TopicTemplateTemplatesNavs $TopicTemplateTemplatesNavsFromJson(Map<String, dynamic> json) {
  ...
  final List<TopicTemplateTemplatesNavsTabs>? tabs = (json['tabs'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<TopicTemplateTemplatesNavsTabs>(e) as TopicTemplateTemplatesNavsTabs)
      .toList();
  if (tabs != null) {
...
TopicTemplateTemplatesNavsTabs $TopicTemplateTemplatesNavsTabsFromJson(Map<String, dynamic> json) {
  ...
  final TopicTemplateTemplatesNavsTabsConfig? config =
      jsonConvert.convert<TopicTemplateTemplatesNavsTabsConfig>(json['config']);
  if (config != null) {
...
TopicTemplateTemplatesNavsTabsCards $TopicTemplateTemplatesNavsTabsCardsFromJson(Map<String, dynamic> json) {
  ...
  final TopicTemplateTemplatesNavsTabsCardsCardMetadata? cardMetadata =
      jsonConvert.convert<TopicTemplateTemplatesNavsTabsCardsCardMetadata>(json['cardMetadata']);
...
TopicTemplateTemplatesNavsTabsConfig $TopicTemplateTemplatesNavsTabsConfigFromJson(Map<String, dynamic> json) {
  final TopicTemplateTemplatesNavsTabsConfig topicTemplateTemplatesNavsTabsConfig =
...
TopicTemplateTemplatesNavsTabsCardsCardMetadata $TopicTemplateTemplatesNavsTabsCardsCardMetadataFromJson(
  ...
  final TopicTemplateTemplatesNavsTabsCardsCardMetadata topicTemplateTemplatesNavsTabsCardsCardMetadata =
      TopicTemplateTemplatesNavsTabsCardsCardMetadata();
  final TopicCardType? cardType =
      jsonConvert.convert<TopicCardType>(json['cardType'], enumConvert: (v) => TopicCardType.values.byName(v));
  if (cardType != null) {
  ...
  if (pageSize != null) {
    topicTemplateTemplatesNavsTabsCardsCardMetadata.pageSize = pageSize;
  }
  final TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfo? compareInfo =
      jsonConvert.convert<TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfo>(json['compareInfo']);
  if (compareInfo != null) {
    topicTemplateTemplatesNavsTabsCardsCardMetadata.compareInfo = compareInfo;
  }
  final List<TopicTemplateTemplatesNavsTabsCardsCardMetadataChartType>? chartType =
      (json['chartType'] as List<dynamic>?)
          ?.map((e) => jsonConvert.convert<TopicTemplateTemplatesNavsTabsCardsCardMetadataChartType>(e)
              as TopicTemplateTemplatesNavsTabsCardsCardMetadataChartType)
          .toList();
  if (chartType != null) {
  ...
  final List<TopicTemplateTemplatesNavsTabsCardsCardMetadataMetrics>? metrics = (json['metrics'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<TopicTemplateTemplatesNavsTabsCardsCardMetadataMetrics>(e)
          as TopicTemplateTemplatesNavsTabsCardsCardMetadataMetrics)
      .toList();
  if (metrics != null) {
    topicTemplateTemplatesNavsTabsCardsCardMetadata.metrics = metrics;
  }
  final List<TopicTemplateTemplatesNavsTabsCardsCardMetadataDims>? dims = (json['dims'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<TopicTemplateTemplatesNavsTabsCardsCardMetadataDims>(e)
          as TopicTemplateTemplatesNavsTabsCardsCardMetadataDims)
      .toList();
  if (dims != null) {
    topicTemplateTemplatesNavsTabsCardsCardMetadata.dims = dims;
  }
  final TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfo? filterInfo =
      jsonConvert.convert<TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfo>(json['filterInfo']);
  if (filterInfo != null) {
    topicTemplateTemplatesNavsTabsCardsCardMetadata.filterInfo = filterInfo;
  }
...
TopicTemplateTemplatesNavsTabsCardsCardMetadataChartType
    $TopicTemplateTemplatesNavsTabsCardsCardMetadataChartTypeFromJson(Map<String, dynamic> json) {
  final TopicTemplateTemplatesNavsTabsCardsCardMetadataChartType
      topicTemplateTemplatesNavsTabsCardsCardMetadataChartType =
      TopicTemplateTemplatesNavsTabsCardsCardMetadataChartType();
  ...
  if (ifDefault != null) {
    topicTemplateTemplatesNavsTabsCardsCardMetadataChartType.ifDefault = ifDefault;
  }
  final String? pageSize = jsonConvert.convert<String>(json['pageSize']);
  if (pageSize != null) {
    topicTemplateTemplatesNavsTabsCardsCardMetadataChartType.pageSize = pageSize;
  }
...
extension TopicTemplateTemplatesNavsTabsCardsCardMetadataChartTypeExtension
    on TopicTemplateTemplatesNavsTabsCardsCardMetadataChartType {
...
TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfo
    $TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfoFromJson(Map<String, dynamic> json) {
  final TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfo
      topicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfo =
      TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfo();
  final AddMetricsCompareType? compareType = jsonConvert.convert<AddMetricsCompareType>(json['compareType'],
  ...
  final List<TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfoMetrics>? metrics =
      (json['metrics'] as List<dynamic>?)
          ?.map((e) => jsonConvert.convert<TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfoMetrics>(e)
              as TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfoMetrics)
          .toList();
  if (metrics != null) {
...
extension TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfoExtension
    on TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfo {
...
TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfoMetrics
    $TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfoMetricsFromJson(Map<String, dynamic> json) {
  final TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfoMetrics
      topicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfoMetrics =
      TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfoMetrics();
...
extension TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfoMetricsExtension
    on TopicTemplateTemplatesNavsTabsCardsCardMetadataCompareInfoMetrics {
...
TopicTemplateTemplatesNavsTabsCardsCardMetadataMetrics $TopicTemplateTemplatesNavsTabsCardsCardMetadataMetricsFromJson(
    Map<String, dynamic> json) {
  final TopicTemplateTemplatesNavsTabsCardsCardMetadataMetrics topicTemplateTemplatesNavsTabsCardsCardMetadataMetrics =
  ...
  final List<TopicTemplateTemplatesNavsTabsCardsCardMetadataMetricExplanation>? metricExplanation =
      (json['metricExplanation'] as List<dynamic>?)
          ?.map((e) => jsonConvert.convert<TopicTemplateTemplatesNavsTabsCardsCardMetadataMetricExplanation>(e)
              as TopicTemplateTemplatesNavsTabsCardsCardMetadataMetricExplanation)
          .toList();
...
extension TopicTemplateTemplatesNavsTabsCardsCardMetadataMetricsExtension
    on TopicTemplateTemplatesNavsTabsCardsCardMetadataMetrics {
...
TopicTemplateTemplatesNavsTabsCardsCardMetadataMetricExplanation
    $TopicTemplateTemplatesNavsTabsCardsCardMetadataMetricExplanationFromJson(Map<String, dynamic> json) {
  final TopicTemplateTemplatesNavsTabsCardsCardMetadataMetricExplanation
      topicTemplateTemplatesNavsTabsCardsCardMetadataMetricExplanation =
      TopicTemplateTemplatesNavsTabsCardsCardMetadataMetricExplanation();
...
extension TopicTemplateTemplatesNavsTabsCardsCardMetadataMetricExplanationExtension
    on TopicTemplateTemplatesNavsTabsCardsCardMetadataMetricExplanation {
...
TopicTemplateTemplatesNavsTabsCardsCardMetadataDims $TopicTemplateTemplatesNavsTabsCardsCardMetadataDimsFromJson(
    Map<String, dynamic> json) {
  final TopicTemplateTemplatesNavsTabsCardsCardMetadataDims topicTemplateTemplatesNavsTabsCardsCardMetadataDims =
...
extension TopicTemplateTemplatesNavsTabsCardsCardMetadataDimsExtension
    on TopicTemplateTemplatesNavsTabsCardsCardMetadataDims {
...
TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfo
    $TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFromJson(Map<String, dynamic> json) {
  final TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfo
      topicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfo =
      TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfo();
  final List<String>? filtersMsg =
      (json['filtersMsg'] as List<dynamic>?)?.map((e) => jsonConvert.convert<String>(e) as String).toList();
  if (filtersMsg != null) {
    topicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfo.filtersMsg = filtersMsg;
  }
  final List<TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFilters>? filters =
      (json['filters'] as List<dynamic>?)
          ?.map((e) => jsonConvert.convert<TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFilters>(e)
              as TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFilters)
          .toList();
  if (filters != null) {
    topicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfo.filters = filters;
  }
  return topicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfo;
}

Map<String, dynamic> $TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoToJson(
    TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfo entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['filtersMsg'] = entity.filtersMsg;
  data['filters'] = entity.filters?.map((v) => v.toJson()).toList();
  return data;
}

extension TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoExtension
    on TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfo {
  TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfo copyWith({
    List<String>? filtersMsg,
    List<TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFilters>? filters,
  }) {
    return TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfo()
      ..filtersMsg = filtersMsg ?? this.filtersMsg
      ..filters = filters ?? this.filters;
  }
}

TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFilters
    $TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFiltersFromJson(Map<String, dynamic> json) {
  final TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFilters
      topicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFilters =
      TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFilters();
  final String? fieldCode = jsonConvert.convert<String>(json['fieldCode']);
  if (fieldCode != null) {
    topicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFilters.fieldCode = fieldCode;
  }
  ...
  if (filterType != null) {
    topicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFilters.filterType = filterType;
  }
  final List<String>? filterValue =
      (json['filterValue'] as List<dynamic>?)?.map((e) => jsonConvert.convert<String>(e) as String).toList();
  if (filterValue != null) {
    topicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFilters.filterValue = filterValue;
  }
  return topicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFilters;
}

Map<String, dynamic> $TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFiltersToJson(
    TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFilters entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
...
extension TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFiltersExtension
    on TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFilters {
  TopicTemplateTemplatesNavsTabsCardsCardMetadataFilterInfoFilters copyWith({
    String? fieldCode,
