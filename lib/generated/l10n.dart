...
class S {
  ...
  String get rs_account {
    return Intl.message('Account', name: 'rs_account', desc: '', args: []);
  }

  /// `Add`
  String get rs_add {
    return Intl.message('Add', name: 'rs_add', desc: '', args: []);
  }
  ...
  String get rs_advanced {
    return Intl.message('Advanced', name: 'rs_advanced', desc: '', args: []);
  }

  /// `Agree`
  String get rs_agree {
    return Intl.message('Agree', name: 'rs_agree', desc: '', args: []);
  }

  /// `Agreed`
  String get rs_agreed {
    return Intl.message('Agreed', name: 'rs_agreed', desc: '', args: []);
  }

  /// `All`
  String get rs_all {
    return Intl.message('All', name: 'rs_all', desc: '', args: []);
  }
  ...
  /// `Apply`
  String get rs_apply {
    return Intl.message('Apply', name: 'rs_apply', desc: '', args: []);
  }
  ...
  String get rs_bottom_nav_mine {
    return Intl.message('My', name: 'rs_bottom_nav_mine', desc: '', args: []);
  }
  ...
  /// `By`
  String get rs_by {
    return Intl.message('By', name: 'rs_by', desc: '', args: []);
  }
  ...
  String get rs_cancel {
    return Intl.message('Cancel', name: 'rs_cancel', desc: '', args: []);
  }
  ...
  /// `Chart`
  String get rs_chart {
    return Intl.message('Chart', name: 'rs_chart', desc: '', args: []);
  }

  /// `Bar Chart`
  String get rs_chart_bar {
    return Intl.message('Bar Chart', name: 'rs_chart_bar', desc: '', args: []);
  }
  ...
  String get rs_chart_list {
    return Intl.message('List', name: 'rs_chart_list', desc: '', args: []);
  }
  ...
  String get rs_chart_pie {
    return Intl.message('Pie chart', name: 'rs_chart_pie', desc: '', args: []);
  }

  /// `Sales`
  String get rs_chart_sales {
    return Intl.message('Sales', name: 'rs_chart_sales', desc: '', args: []);
  }
  ...
  /// `Check`
  String get rs_check {
    return Intl.message('Check', name: 'rs_check', desc: '', args: []);
  }
  ...
  String get rs_clean_all {
    return Intl.message('Clear All', name: 'rs_clean_all', desc: '', args: []);
  }

  /// `Collapse`
  String get rs_collapse {
    return Intl.message('Collapse', name: 'rs_collapse', desc: '', args: []);
  }

  /// `compared`
  String get rs_compare {
    return Intl.message('compared', name: 'rs_compare', desc: '', args: []);
  }
  ...
  String get rs_compared {
    return Intl.message('Compared', name: 'rs_compared', desc: '', args: []);
  }
  ...
  String get rs_confirm {
    return Intl.message('Confirm', name: 'rs_confirm', desc: '', args: []);
  }

  /// `Company`
  String get rs_corporation {
    return Intl.message('Company', name: 'rs_corporation', desc: '', args: []);
  }
  ...
  String get rs_current {
    return Intl.message('Current', name: 'rs_current', desc: '', args: []);
  }

  /// `Custom`
  String get rs_custom {
    return Intl.message('Custom', name: 'rs_custom', desc: '', args: []);
  }
  ...
  String get rs_date_day {
    return Intl.message('Day', name: 'rs_date_day', desc: '', args: []);
  }

  /// `Month`
  String get rs_date_month {
    return Intl.message('Month', name: 'rs_date_month', desc: '', args: []);
  }
  ...
  /// `Debug`
  String get rs_debug {
    return Intl.message('Debug', name: 'rs_debug', desc: '', args: []);
  }
  ...
  String get rs_delete {
    return Intl.message('Delete', name: 'rs_delete', desc: '', args: []);
  }
  ...
  /// `Dimension`
  String get rs_dim {
    return Intl.message('Dimension', name: 'rs_dim', desc: '', args: []);
  }
  ...
  String get rs_disagree {
    return Intl.message('Disagree', name: 'rs_disagree', desc: '', args: []);
  }
  ...
  /// `Edit`
  String get rs_edit {
    return Intl.message('Edit', name: 'rs_edit', desc: '', args: []);
  }
  ...
  /// `Email`
  String get rs_email {
    return Intl.message('Email', name: 'rs_email', desc: '', args: []);
  }
  ...
  String get rs_expand {
    return Intl.message('Expand', name: 'rs_expand', desc: '', args: []);
  }
  ...
  String get rs_feedback_send {
    return Intl.message('Submit', name: 'rs_feedback_send', desc: '', args: []);
  }

  /// `Filter`
  String get rs_filter {
    return Intl.message('Filter', name: 'rs_filter', desc: '', args: []);
  }
  ...
  /// `Group`
  String get rs_group {
    return Intl.message('Group', name: 'rs_group', desc: '', args: []);
  }
  ...
  /// `Input`
  String get rs_input {
    return Intl.message('Input', name: 'rs_input', desc: '', args: []);
  }
  ...
  /// `Later`
  String get rs_later {
    return Intl.message('Later', name: 'rs_later', desc: '', args: []);
  }
  ...
  String get rs_location {
    return Intl.message('Store', name: 'rs_location', desc: '', args: []);
  }
  ...
  String get rs_login_change {
    return Intl.message('Replace', name: 'rs_login_change', desc: '', args: []);
  }

  /// `Email`
  String get rs_login_email {
    return Intl.message('Email', name: 'rs_login_email', desc: '', args: []);
  }
  ...
  String get rs_login_resend {
    return Intl.message('Resend', name: 'rs_login_resend', desc: '', args: []);
  }
  ...
  String get rs_logout {
    return Intl.message('Log out', name: 'rs_logout', desc: '', args: []);
  }
  ...
  String get rs_metric {
    return Intl.message('Indicator', name: 'rs_metric', desc: '', args: []);
  }
  ...
  String get rs_metrics {
    return Intl.message('Indicator', name: 'rs_metrics', desc: '', args: []);
  }
  ...
  /// `Month`
  String get rs_month {
    return Intl.message('Month', name: 'rs_month', desc: '', args: []);
  }
  ...
  /// `Name`
  String get rs_name {
    return Intl.message('Name', name: 'rs_name', desc: '', args: []);
  }

  /// `Next step`
  String get rs_next {
    return Intl.message('Next step', name: 'rs_next', desc: '', args: []);
  }

  /// `Next step`
  String get rs_next_step {
    return Intl.message('Next step', name: 'rs_next_step', desc: '', args: []);
  }

  /// `No Data`
  String get rs_no_data {
    return Intl.message('No Data', name: 'rs_no_data', desc: '', args: []);
  }
  ...
  String get rs_others {
    return Intl.message('Other', name: 'rs_others', desc: '', args: []);
  }

  /// `Phone number`
  String get rs_phone {
    return Intl.message('Phone number', name: 'rs_phone', desc: '', args: []);
  }
  ...
  String get rs_progress {
    return Intl.message('Progress', name: 'rs_progress', desc: '', args: []);
  }

  /// `Proportion`
  String get rs_rate {
    return Intl.message('Proportion', name: 'rs_rate', desc: '', args: []);
  }
  ...
  String get rs_reload {
    return Intl.message('Reload', name: 'rs_reload', desc: '', args: []);
  }

  /// `Rest day`
  String get rs_rest_day {
    return Intl.message('Rest day', name: 'rs_rest_day', desc: '', args: []);
  }

  /// `Save`
  String get rs_save {
    return Intl.message('Save', name: 'rs_save', desc: '', args: []);
  }

  /// `Choose`
  String get rs_select {
    return Intl.message('Choose', name: 'rs_select', desc: '', args: []);
  }
  ...
  String get rs_setting {
    return Intl.message('Setting', name: 'rs_setting', desc: '', args: []);
  }

  /// `View All`
  String get rs_show_all {
    return Intl.message('View All', name: 'rs_show_all', desc: '', args: []);
  }
  ...
  /// `Sorting`
  String get rs_sort {
    return Intl.message('Sorting', name: 'rs_sort', desc: '', args: []);
  }

  /// `Shop`
  String get rs_store {
    return Intl.message('Shop', name: 'rs_store', desc: '', args: []);
  }

  /// `Sure`
  String get rs_sure {
    return Intl.message('Sure', name: 'rs_sure', desc: '', args: []);
  }
  ...
  String get rs_template {
    return Intl.message('Template', name: 'rs_template', desc: '', args: []);
  }

  /// `Theme`
  String get rs_theme {
    return Intl.message('Theme', name: 'rs_theme', desc: '', args: []);
  }
  ...
  /// `Topic`
  String get rs_topic {
    return Intl.message('Topic', name: 'rs_topic', desc: '', args: []);
  }
  ...
  String get rs_update_paused {
    return Intl.message('Pause', name: 'rs_update_paused', desc: '', args: []);
  }
  ...
  String get rs_version {
    return Intl.message('Version', name: 'rs_version', desc: '', args: []);
  }

  /// `comparison`
  String get rs_vs {
    return Intl.message('comparison', name: 'rs_vs', desc: '', args: []);
  }

  /// `Weekday`
  String get rs_workday {
    return Intl.message('Weekday', name: 'rs_workday', desc: '', args: []);
  }

  /// `Analysis`
  String get rs_analysis {
    return Intl.message('Analysis', name: 'rs_analysis', desc: '', args: []);
  }
  ...
  /// `Change identity`
  String get rs_change_identity {
    return Intl.message(
      'Change identity',
      name: 'rs_change_identity',
      desc: '',
      args: [],
    );
  }
  ...
  /// `I am the boss`
  String get rs_identity_i_am_boss {
    return Intl.message(
      'I am the boss',
      name: 'rs_identity_i_am_boss',
      desc: '',
      args: [],
    );
  }

  /// `Focus on data to make decisions`
  String get rs_identity_i_am_boss_desc {
    return Intl.message(
      'Focus on data to make decisions',
      name: 'rs_identity_i_am_boss_desc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Boss`
  String get rs_identity_boss {
    return Intl.message('Boss', name: 'rs_identity_boss', desc: '', args: []);
  }

  /// `I am the shop manager`
  String get rs_identity_i_am_shop_administrator {
    return Intl.message(
      'I am the shop manager',
      name: 'rs_identity_i_am_shop_administrator',
      desc: '',
      args: [],
    );
  }

  /// `Focus on store data, manage store operations`
  String get rs_identity_i_am_shop_administrator_desc {
    return Intl.message(
      'Focus on store data, manage store operations',
      name: 'rs_identity_i_am_shop_administrator_desc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Shop manager`
  String get rs_identity_shop_administrator {
    return Intl.message(
      'Shop manager',
      name: 'rs_identity_shop_administrator',
      desc: '',
      args: [],
    );
  }

  /// `I am a supply chain coordinator`
  String get rs_identity_i_am_supply_chain_coordinator {
    return Intl.message(
      'I am a supply chain coordinator',
      name: 'rs_identity_i_am_supply_chain_coordinator',
      desc: '',
      args: [],
    );
  }

  /// `Responsible for inventory management, purchasing, shipping, etc.`
  String get rs_identity_i_am_supply_chain_coordinator_desc {
    return Intl.message(
      'Responsible for inventory management, purchasing, shipping, etc.',
      name: 'rs_identity_i_am_supply_chain_coordinator_desc',
      desc: '',
      args: [],
    );
  }
  ...
  String get rs_identity_supply_chain_coordinator {
    return Intl.message(
      'Supply chain coordinator',
      name: 'rs_identity_supply_chain_coordinator',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Workbench`
  String get rs_scm_bottom_nav_workbench {
    return Intl.message(
      'Workbench',
      name: 'rs_scm_bottom_nav_workbench',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Home`
  String get rs_scm_bottom_nav_overview {
    return Intl.message(
      'Home',
      name: 'rs_scm_bottom_nav_overview',
      desc: '',
      args: [],
    );
  }
