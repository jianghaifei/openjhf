...
class RSAccountManager {
  ...
  Future<void> setAccessToken(String accessToken) async {
    ...
    if (localUserInfo != null) {
      localUserInfo.accessToken = accessToken;
      await loginSuccess(localUserInfo);
    }
  }

  /// 设置集团id
  Future<void> setCorporationId(String corporationId) async {
    UserInfoEntity? localUserInfo = RSAccountManager().userInfoEntity;

    if (localUserInfo != null) {
      localUserInfo.employee?.corporationId = corporationId;
      await loginSuccess(localUserInfo);
    }
  }
