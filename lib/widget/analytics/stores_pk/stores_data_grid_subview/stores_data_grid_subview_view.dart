...
class _StoresDataGridSubviewPageState extends State<StoresDataGridSubviewPage> {
          ...
          child: SfDataGrid(
            ...
            onCellTap: (DataGridCellTapDetails details) {
              ...
              if (details.rowColumnIndex.columnIndex != 0 && details.rowColumnIndex.rowIndex == 0) {
                // 排序
                setGridColumnSort(details.column);
  ...
  List<GridColumn> _buildTitlesWidget() {
    ...
    titles?.forEach((element) {
      var tmpGridColumn = GridColumn(
          ...
          columnName: titleCodes?[index] ?? '$index',
      ...
      if (index == 1) {
        setGridColumnSort(tmpGridColumn);
      }
  ...
  void setGridColumnSort(GridColumn details) {
    if (!_storeDataSource.showComparison) {
      _storeDataSource.showComparison = true;
    }

    if (_storeDataSource.currentColumnName != details.columnName) {
      _storeDataSource.currentColumnName = details.columnName;
    ...
    _storeDataSource.sortedColumns.add(SortColumnDetails(name: details.columnName, sortDirection: sortDirection));
