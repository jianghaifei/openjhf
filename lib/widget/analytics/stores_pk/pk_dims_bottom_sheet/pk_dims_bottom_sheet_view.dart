...
typedef ApplyCallback = Function(StorePKCardMetadataCardGroupMetadataDims selectedDim, String cardGroupCode);
          ...
          return RSFormCommonTypeWidget.buildRadioFormWidget(dims?[index].dimName ?? '', ifSelected, (check) {
            if (dims?[index] != null) {
              setState(() {
                ...
                widget.callback(
                    state.selectedDim.value, state.entity.value.cardMetadata?.cardGroup?[tabIndex].groupCode ?? '');
              });
