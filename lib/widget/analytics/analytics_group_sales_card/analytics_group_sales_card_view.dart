...
class _AnalyticsGroupSalesCardPageState extends State<AnalyticsGroupSalesCardPage> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return MetricCardGeneralWidget(
        ...
        padding: EdgeInsets.only(top: 16, bottom: spacing),
        child: InkWell(
          onTap: () {
            if (widget.pageEditing) {
              logic.jumpEditPage();
  ...
  Widget _createWrapWidget() {
    ...
    if (state.resultModuleGroupMetricsEntity.value.reportData != null &&
        ...
        state.resultModuleGroupMetricsEntity.value.reportData!.rows!.length <= RSColor.chartColors.length) {
        ...
        widgets.add(
          InkWell(
            ...
            child: _createWrapItemWidget(
                title, percent, displayValue, abbrDisplayValue, abbrDisplayUnit, RSColor.chartColors[i]),
          ),
        );
      }
    }
  ...
  Widget _createListWidget() {
    return Column(children: [
      ...
      // if (state.resultModuleGroupMetricsEntity.value.reportData?.page != null &&
      //     state.resultModuleGroupMetricsEntity.value.reportData!.page!.pageCount > 1)
